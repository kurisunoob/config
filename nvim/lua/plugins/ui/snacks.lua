return {
  ...
  opts = {
    ...
    notifier = {
      enabled = true,
      timeout = 10000,
      timeout_fn = function(n)
        local l = n.level or vim.log.levels.INFO
        if l >= vim.log.levels.ERROR then return 15000 end
        if l >= vim.log.levels.WARN then return 12000 end
        return 10000
      end,
...
╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝]],
  ...
  keys = {
    { "<leader>nuC", function() Snacks.picker.colorschemes() end, desc = "Colorschemes" },
